...
export default function () {
  ...
  const command = 'secllama run llama3.2'
        ...
        {step === Step.WELCOME && (
          <>
            <div className='mx-auto text-center'>
              <h1 className='mb-6 mt-4 text-2xl tracking-tight text-gray-900'>Welcome to SecLlama 🔒</h1>
              <p className='mx-auto w-[65%] text-sm text-gray-400'>
                Secure, Private, Offline AI. Let's get you up and running with encrypted, sandboxed large language models.
              </p>
              <button
        ...
        {step === Step.CLI && (
          <>
            <div className='mx-auto flex flex-col space-y-28 text-center'>
              ...
              <pre className='mx-auto text-4xl text-gray-400'>&gt; secllama</pre>
              <div className='mx-auto'>
                <button
                  onClick={async () => {
                    try {
